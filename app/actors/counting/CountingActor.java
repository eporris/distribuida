...
public class CountingActor extends UntypedActor {
	...
	public void onReceive(Object message) throws Exception {
		...
		if (message instanceof ChildsCountDown){
			...
			ActorRef child1 = getContext().system().actorOf(Props.create(CountingActor.class), "child1");
			ActorRef child2 = getContext().system().actorOf(Props.create(CountingActor.class), "child2");
